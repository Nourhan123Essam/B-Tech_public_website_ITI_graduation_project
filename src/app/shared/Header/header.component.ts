        ...
        this.categories = res.entity
          .map((category: any) => {
            ...
            if (
              ...
              categoryName === 'TVs' ||
              categoryName === 'تلفزيونات وريسيفرات'
            ) {
              subCategories = [
                'LED TVs',
                'Smart TVs',
              ...
              categoryName === 'small home application' ||
              categoryName === 'أجهزة منزلية صغيرة'
            ) {
              subCategories = [
                'Laptops',
                'Desktops',
              ...
              categoryName === 'mobile and tablet' ||
              categoryName === 'لاب توب و كمبيوتر'
            ) {
